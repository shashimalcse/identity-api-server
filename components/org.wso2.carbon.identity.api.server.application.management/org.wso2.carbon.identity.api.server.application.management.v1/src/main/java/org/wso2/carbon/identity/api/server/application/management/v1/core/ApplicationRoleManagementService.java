...
public class ApplicationRoleManagementService {
     ...
     */
    public Role updateApplicationRoleAssignedUsers(String applicationId, String roleId,
     ...
     * @param roleId        Role ID.
     */
    public Role getApplicationRoleAssignedUsers(String applicationId, String roleId) {
     ...
     * @param roleAssignUpdateModel    Role assign update.
     */
    public Role updateApplicationRoleAssignedGroups(String applicationId, String roleId, String idpId,
                                                   RoleAssignPatchModel roleAssignUpdateModel) {
     ...
     * @param roleId        Role ID.
     */
    public Role getApplicationRoleAssignedGroups(String applicationId, String roleId, String idp) {
